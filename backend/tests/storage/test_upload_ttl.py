...
def test_upload_ttl_is_clamped_higher(s3_storage, fake_s3) -> None:  # noqa: ANN001
    url = s3_storage.presign_put("docs-quarantine/t/k", 600, content_type="text/plain", max_bytes=100)
    assert fake_s3.calls_to("generate_presigned_post")[0]["ExpiresIn"] == 600


def test_local_upload_ttl_is_clamped_higher(local_storage, monkeypatch) -> None:  # noqa: ANN001
    import time
