...
def test_authorised_caller_gets_409_while_processing(client_factory, monkeypatch) -> None:
...
def test_held_document_reports_its_own_state(client_factory) -> None:
...
def test_cross_tenant_404_is_byte_identical_to_nonexistent(client_factory) -> None:
